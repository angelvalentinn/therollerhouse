export const PRODUCTOS = [
    {
        ...
        description: [
            "Diseñadas para bloquear 99% de la luz exterior, creando un ambiente oscuro y relajante ideal para dormir y ver películas",
        ],
    ...
    {   
        id: 2, 
        title: "Screen 5% Nordic",
        description: [`Diseñadas para permitir que la luz se filtre hacia adentro y para "ver a través" cuando se bajan las persianas.
